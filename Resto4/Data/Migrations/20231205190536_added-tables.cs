...
namespace Resto4.Data.Migrations
{
    ...
    public partial class addedtables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlatId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlatName = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plat_Category_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartDetail_Plat_PlatId",
                        column: x => x.PlatId,
                        principalTable: "Plat",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetail_PlatId",
                table: "OrderDetail",
                column: "PlatId");

            migrationBuilder.CreateIndex(
                name: "IX_Plat_CategoryId",
                table: "Plat",
                column: "CategoryId");
        }
